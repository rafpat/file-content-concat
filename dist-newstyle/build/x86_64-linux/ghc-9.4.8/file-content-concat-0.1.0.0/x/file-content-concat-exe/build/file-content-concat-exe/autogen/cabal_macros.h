...
/* package file-content-concat-0.1.0.0 */
#ifndef VERSION_file_content_concat
#define VERSION_file_content_concat "0.1.0.0"
#endif /* VERSION_file_content_concat */
#ifndef MIN_VERSION_file_content_concat
#define MIN_VERSION_file_content_concat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_file_content_concat */
...
#define CURRENT_COMPONENT_ID "file-content-concat-0.1.0.0-inplace-file-content-concat-exe"
